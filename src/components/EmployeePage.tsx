    ...
    <div className="container mx-auto p-4">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="w-20 mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
        />
      </div>
